...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<Map<String, String>> login(@org.springframework.web.bind.annotation.RequestBody LoginRequestDto req,
    ...
    public ResponseEntity<String> register(
            ...
            @ModelAttribute UserRequestDto userDetailDto) {
